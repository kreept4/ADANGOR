      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ background: "#0D0904", padding: "clamp(24px, 4vw, 56px) clamp(20px, 4vw, 64px)", overflow: "visible" }}
          >
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-end">
              ...
              {/* Exact geometry pulled from Figma (node 644:23925): box is 584.572 x 273
                  ...
                  overflows the card by ~15.6px right / ~13px bottom. That overflow, sitting
                  on the white page background beneath the card, IS the "pocket" — no
                  separate white shape needed. */}
              <div
                ...
                style={{
                  ...
                  marginRight: "clamp(-8px, -1.112vw, -16px)",
                  marginBottom: "clamp(-6px, -0.929vw, -13px)",
                }}
              >
                <span
                  aria-hidden
