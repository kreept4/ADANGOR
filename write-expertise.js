...
fs.writeFileSync('app/components/Expertise.tsx', `"use client";
...
export default function Expertise() {
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 py-12 lg:px-[96px] lg:py-24">
        <h2
          style={{
            color: "#CD9610",
            fontWeight: 400,
          ...
          className="text-[32px] lg:text-[48px] mb-6 lg:mb-10"
        >
          EXPERTISE
        </h2>
...
console.log('Expertise.tsx: dummy HOME rows removed, container widened to full section');